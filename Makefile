...
sokomethod: $(OUTPUT)/main.o $(OUTPUT)/sokopush.o $(OUTPUT)/soko_pos_operation.o $(OUTPUT)/soko_map_operation.o
	gcc -g -std=c99 -o sokomethod $(OUTPUT)/main.o $(OUTPUT)/sokopush.o $(OUTPUT)/soko_pos_operation.o $(OUTPUT)/soko_map_operation.o
$(OUTPUT)/main.o: $(SRC)/main.c $(INCLUDE)/sokopush.h $(INCLUDE)/debug.h
	gcc -g -std=c99 -I $(INCLUDE) -c $(SRC)/main.c -o $(OUTPUT)/main.o
